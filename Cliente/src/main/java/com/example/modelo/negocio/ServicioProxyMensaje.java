...
public class ServicioProxyMensaje {
	...
	public static final String URL = "http://localhost:8080/msj";
	...
	/**
	 * Metodo que consume el servicio rest hubicado en "http://localhost:8080/" En
	 * funcion del path devolvera el mensaje normal o el mensaje HTML
	 * 
	 * @param path, el path del mensaje que queremos acceder, dos posibles valores.
	 *              "mensaje" que nos devuelve el mensaje en texto y "mensajeHTML"
	 *              que nos devuelve un mensaje en HTML
	 * @return string con la cadena en texto plano o en texto html en función del
